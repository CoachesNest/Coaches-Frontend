...
const features = [
  ...
  },
  {
    ...
    description:
      'Build a verifiable record of your contributions and community engagement across the Coaches network.',
  },
];
  ...
  return (
    <section className="py-16 bg-[#F9F7FF]">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl font-bold mb-4">Why Choose Coaches?</h2>
        <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
          Coaches leverages web3 to enhance your learning journey, offering benefits not found on traditional platforms.
        </p>
