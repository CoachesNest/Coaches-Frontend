...
const features = [
  ...
  },
  {
    ...
    description:
      'Build a verifiable record of your contributions and community engagement across the  Coachesnetwork.',
  },
];
    ...
    <section className="py-16 bg-[#F9F7FF]">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
           Coachesleverages web3 to enhance your learning journey, offering benefits not found on traditional platforms.
        </p>
