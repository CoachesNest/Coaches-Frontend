...
The Community module lets users connect, share knowledge, and engage with the  Coachesplatform. It lives under the authenticated dashboard route and provides:
