...
This document outlines all image optimizations implemented for the  Coachesplatform using Next.js Image component.
...
All images in the  Coachesplatform have been optimized using Next.js Image component. The changes result in:
