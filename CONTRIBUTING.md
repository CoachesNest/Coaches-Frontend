...
## How to Contribute
### 1. Find an Issue
Check out our [good first issues](https://github.com/MentoNest/coaches_frontend/labels/good%20first%20issue) or [help wanted](https://github.com/MentoNest/coaches_frontend/labels/help%20wanted) to find tasks that are perfect for new contributors.
