...
export default function Home() {
  ...
  return (
    ...
    <>
        ...
        <div className="grid max-w-screen-xl px-4 py-12 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 items-center">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
               Coacheshelps you connect with experienced professionals to guide
      ...
      <section className="bg-white dark:bg-gray-900 transition-colors" aria-label="About  Coachestools">
        <div className="gap-8 items-center py-12 px-4 mx-auto max-w-screen-xl xl:gap-16 grid grid-cols-1 md:grid-cols-2 lg:px-6">
          <div className="w-full flex justify-center">
            <Image 
              ...
              alt=" Coachesweb platform interface preview showing mentors list and schedule builder" 
            />
            <Image 
              width={1200} 
              height={800} 
              ...
              alt=" Coachesdark mode platform interface preview showcasing career progress dashboard" 
            />
          </div>
          <div className="mt-4 md:mt-0 flex flex-col items-start">
            ...
            <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
               Coacheshelps you connect with professional communities, find vetted mentors, and collaborate with peers who share your professional interests. Empower your career growth through custom roadmaps and expert coaching.
            </p>
            <Link 
              href="/register" 
      ...
      <section className="bg-cyan-600 dark:bg-cyan-800 transition-colors" aria-label="CTA Sign Up">
        <div className="py-16 px-4 mx-auto max-w-screen-xl sm:py-20 lg:px-6 text-center">
          ...
          <p className="mb-8 font-light text-cyan-100 md:text-lg max-w-xl mx-auto">
            Join  Coachestoday and connect with mentors who can help you achieve your goals. Take control of your career journey.
          </p>
          <Link href="/register" className="inline-flex">
