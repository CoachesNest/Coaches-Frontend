        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-white">Coaches</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <footer className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8 pb-6">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400">© 2026 Coaches. All rights reserved. Empowering growth through mentorship.</p>
          </div>
        </footer>
      </main>
    </div>
