...
const testimonials = [
  {
    id: 1,
    quote:
      " Coachespaired me with a senior engineer who completely changed my trajectory. Within 6 months I landed my first role at a FAANG company. The structured sessions and accountability made all the difference.",
    name: "Amara Osei",
  ...
  },
  {
    id: 2,
    quote:
      "I'd tried other mentorship platforms but nothing stuck.  Coachesmatched me with someone who had walked the exact path I wanted. The quality of mentors here is genuinely unmatched.",
    name: "Liam Nakamura",
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="mt-5 text-lg text-[oklch(0.704_0.04_256.788)]">
            Real outcomes from real people who invested in their growth with Coaches.
          </p>
        </div>
