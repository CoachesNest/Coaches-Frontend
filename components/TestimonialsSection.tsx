...
const testimonials: Testimonial[] = [
  {
    initials: 'AK',
    quote:
      " Coachesconnected me with a mentor who completely transformed my approach to system design. Within three months, I earned my first promotion to senior engineer.",
    name: 'Alex Kim',
  ...
  },
  {
    initials: 'DT',
    quote:
      "I was stuck in my career growth until I found Coaches. My mentor gave me the honest feedback and strategic guidance I needed to break through to the next level.",
    name: 'David Thompson',
  ...
  },
  {
    initials: 'SR',
    quote:
      "The community aspect sets  Coachesapart. I joined for mentorship but gained a network of incredible peers who constantly challenge and support me.",
    name: 'Sarah Rivera',
