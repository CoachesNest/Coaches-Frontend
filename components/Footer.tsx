    ...
    <footer className="bg-purple-800 py-8 text-white" aria-label="Site footer">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <nav className="col-span-1" aria-label="Social media links">
            ...
            <div className="flex space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Follow  Coacheson LinkedIn"
                className="hover:text-gray-300 focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Follow  Coacheson Pinterest"
                className="hover:text-gray-300 focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Copyright */}
          <div className="col-span-1 md:col-span-1">
            <p className="text-gray-400">&copy; 2024 Coaches. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
