  ...
  const testimonials = [
    {
      ...
      quote:
        " Coachesconnected me with an amazing mentor who helped me transition from marketing to product management. The personalized guidance was exactly what I needed.",
    ...
    },
    {
      ...
      quote:
        "As a mentor on Coaches, I've had the opportunity to guide talented professionals. The platform makes it easy to share knowledge and make a real impact.",
      name: "Michael Chen",
    ...
    },
    {
      ...
      quote:
        "I was stuck in my career for years. My  Coachesmentor helped me identify my strengths and navigate a successful pivot into data science. Truly life-changing.",
    ...
    },
    {
      ...
      quote:
        "The flexible scheduling and quality of mentorship on  Coachesis unmatched. I've grown more in 6 months than I did in 2 years on my own.",
      name: "Priya Sharma",
      role: "Marketing Lead",
    },
    {
      ...
      quote:
        "Being able to connect with industry leaders who genuinely care about my growth has been incredible.  Coachesmade mentorship accessible and affordable.",
      name: "James Wilson",
